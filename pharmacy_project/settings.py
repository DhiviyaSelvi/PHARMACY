...
# Razorpay Settings
RAZOR_KEY_ID = config('RAZORPAY_KEY_ID', default=config('RAZOR_KEY_ID', default=''))
RAZOR_KEY_SECRET = config('RAZORPAY_KEY_SECRET', default=config('RAZOR_KEY_SECRET', default=''))
